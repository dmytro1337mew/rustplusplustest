...
module.exports = {
    ...
    discord: {
        username: process.env.RPP_DISCORD_USERNAME || 'Meow Meow',
        clientId: process.env.RPP_DISCORD_CLIENT_ID || '1265000057837453354',
        token: process.env.RPP_DISCORD_TOKEN || 'MTI2NTAwMDA1NzgzNzQ1MzM1NA.G5ynCn.ryT6zfVKBDB3W2Zp1fUo5dGgTMgWDTw6VsUotA',
